# Generated by Django 5.0.4 on 2024-11-19 16:37
import random
...
def reverse_generate_barcodes(apps, schema_editor):
    Product = apps.get_model('main_app', 'Product')
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(generate_barcodes, reverse_generate_barcodes)]
