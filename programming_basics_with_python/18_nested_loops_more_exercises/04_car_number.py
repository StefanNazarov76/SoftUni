...
for first_number in range(start_number, end_number + 1):
    for second_number in range(start_number, end_number + 1):
        for third_number in range(start_number, end_number + 1):
            for forth_number in range(start_number, end_number + 1):
                if (((first_number % 2 == 0 and forth_number % 2 != 0)
                    or (first_number % 2 != 0 and forth_number % 2 == 0))
                        and first_number > forth_number and ((second_number + third_number) % 2) == 0):
